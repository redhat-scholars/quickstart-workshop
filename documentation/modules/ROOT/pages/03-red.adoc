...
3. Install the red team quickstart, providing an introduction to `odo`:
+
[.console-input]
[source,bash,subs="+macros,+attributes"]
----
...
4. Search all quickstarts for a new entry named "Local development with odo 3.0"

5. Start the quickstart and follow along with each step.  Confirm your findings.
